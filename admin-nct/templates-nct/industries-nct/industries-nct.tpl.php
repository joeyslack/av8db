    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-dark">
            ...
            <div class="portlet-body portlet-toggler">
                <table id="dt_industries" class="table table-striped table-bordered table-hover"></table>
            </div>
...
<script type="text/javascript">
    ...
    $(function () {
        OTable = $('#dt_industries').dataTable({
            bProcessing: true,
                bServerSide: true,
                ...
                "aaSorting" : [],
                aoColumns: [
                { "sName": "id", 'sTitle': "Industry ID", 'bVisible': false},
                { sName: "industry_name_<?= DEFAULT_LANGUAGE_ID ?>", sTitle : "Business Type name(<?= DEFAULT_LANGUAGE_TITLE ?>)"}
...
<?php } ?>
    ...
    $(document).on('click', '#submitAddForm', function (e) {
        ...
        $("#industry_form").validate({
            ...
            messages: {
                industry_name: {
                    ...
                    remote: "&nbsp; Entered business type already exists."
                },
                industry_description: {
                    required: "&nbsp; Please enter business type description.",
                }
            },
        ...
        if ($("#industry_form").valid()) {
            ajaxFormSubmit("#industry_form");
        } else {
            return false;
        }
    });
