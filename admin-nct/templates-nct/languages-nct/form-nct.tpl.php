<form action="" method="post" name="frmCont" id="frmCont" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
    <div class="form-body">
        <div class="form-group"> 
            <label for="language" class="control-label col-md-3">%MEND_SIGN%Language : &nbsp;</label> 
            <div class="col-md-4"> 
                <input type="text" class="form-control required" name="language" id="language" value="%LANGUAGE%" />
            </div>
        </div>
