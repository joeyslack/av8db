<form action="" method="post" name="group_type_form" id="group_type_form" class="form-horizontal" enctype="multipart/form-data" novalidate="novalidate">
    <div class="form-body">
        <!-- <div class="form-group" style="display: none;"> 
            <label class="control-label col-md-3">%MEND_SIGN%Group Type : &nbsp;</label> 
            <div class="col-md-4"> 
                <input type="text" class="form-control required" name="group_type" id="group_type" value="%GROUP_TYPE%" />
            </div>
        </div>
        
        <div class="form-group" style="display: none;"> 
            <label class="control-label col-md-3">%MEND_SIGN%Group type description : &nbsp;</label> 
            <div class="col-md-4"> 
                <textarea name="group_type_description" id="group_type_description" class="form-control required">%GROUP_TYPE_DESCRIPTION%</textarea>
            </div>
        </div> -->
