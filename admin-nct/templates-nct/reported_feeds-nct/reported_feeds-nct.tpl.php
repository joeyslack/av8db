    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-dark">
            ...
            <div class="portlet-body portlet-toggler">
                <table id="dt_feeds" class="table table-striped table-bordered table-hover"></table>
            </div>
    ...
    $(document).ready(function() {
        ...
        OTable = $('#dt_feeds').dataTable({
            bProcessing: true,
                ...
                "aaSorting" : [],
                aoColumns: [
                    { sName: "id", 'sTitle': "Feed Id"},
                    { sName: "user_id", sTitle : "User Name"},
                    { sName: "description", sTitle : "Feed Description"}
