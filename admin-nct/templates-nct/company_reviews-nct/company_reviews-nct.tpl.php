...
<script type="text/javascript">
        ...
        OTable = $('#dt_airports').dataTable({
            bProcessing: true,
                ...
                aoColumns: [
                    ...
                    { sName: "company_id", sTitle : "Business Name"},
                    { sName: "review_description", sTitle : "Review Description"},
                    { sName: "rating", sTitle : "Rating"},
    ...
    $(document).on('click', '#submitAddForm', function (e) {
        ...
        if ($("#company_review_form").valid()) {
            ajaxFormSubmit("#company_review_form");
        } else {
            return false;
        }
    });
