...
include("class.ferry_pilot_reviews-nct.php");
$module = "ferry_pilot_reviews-nct";
$table = "tbl_ferry_pilot_rating";
...
$headTitle = $type == 'add' ? 'Add' : ($type == 'edit' ? 'Edit' : 'Manage') . ' Ferry Pilot Reviews';
...
$objLicenses = new FerryPilotReviews($module, $id, NULL, $searchArray, $type);
