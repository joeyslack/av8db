...
class Adhoc_inmail_pricings extends Home {
    ...
    public function viewForm() {
        ...
        $content = $this->displayBox(array("label" => "Plan Name&nbsp;:", "value" => filtering($this->plan_name))) .
                $this->displayBox(array("label" => "Plan Type&nbsp;:", "value" => filtering($this->plan_type_text))) .
                $this->displayBox(array("label" => "Plan Description &nbsp;:", "value" => filtering($this->plan_description))) .
    ...
    public function getForm($plan_type = 'r') {
        ...
        if ($plan_type == 'r') {
            ...
            foreach ($this->get_languages as $lang) {
                ...
                $area_field_value = $plan_details['plan_description_'.$lang['id']];
                $area_replace = array($lang['id'],$area_label,$area_field_name,$area_field_value);
                $plan_description_new .= str_replace($search, $area_replace, $textarea);
            }
        }
    ...
    public function dataGrid() {
        ...
        foreach ($qrySel as $fetchRes) {
            ...
            $final_array = array_merge($final_array, array(filtering($fetchRes["plan_name"])));
