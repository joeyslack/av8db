...
include("class.company_reviews-nct.php");
$module = "company_reviews-nct";
$table = "tbl_company_rate_review";
...
$headTitle = $type == 'add' ? 'Add' : ($type == 'edit' ? 'Edit' : 'Manage') . ' Business Reviews';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($type == 'edit' && $id > 0) {
        ...
        if (in_array('edit', $Permission)) {
            ...
            $response['success'] = "Business review has been updated successfully.";
        } else {
...
$objLicenses = new CompanyReviews($module, $id, NULL, $searchArray, $type);
