...
class Users extends Home {
    ...
    public function dataGrid() {
        ...
        if($admSl['id']==2){
            ...
            if ($whereCond) {
                $whereCond .= " AND u.type = 'o' ";
            } else {
                $whereCond .= " WHERE u.type = 'o' ";
            }
        ...
        foreach ($qrySel as $fetchRes) {
            ...
            $operation .=(in_array('view', $this->Permission)) ? '&nbsp;&nbsp;' . $this->operation(array("href" => SITE_ADMIN_URL. "user-dashboard/" . $fetchRes['id'], "class" => "btn default blue btn-xs ", "value" => '<i class="fa fa-laptop"></i>&nbsp;View')) : '';
            ...
            $final_array = array(
                ...
                filtering($firstName),
                filtering($lastName),
                getUserProfilePictureURL(filtering($fetchRes['id'], 'output', 'int'), 'th2'),
