...
class Languages extends Home {
    ...
    public function viewForm() {
        $content = $this->displayBox(array("label" => "Language &nbsp;:", "value" => $this->language)) .
    ...
    public function dataGrid() {
        ...
        $whereCond = '';
        if (isset($chr) && $chr != '') {
            $whereCond .= " WHERE ( language LIKE '%" . $chr . "%'  )";
        }
