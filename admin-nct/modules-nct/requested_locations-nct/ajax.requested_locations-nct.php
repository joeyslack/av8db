...
include("class.requested_locations-nct.php");

$module = 'requested_locations-nct';
...
if($action == "approveAddressType" && in_array('status',$Permission)) {
        ...
        echo json_encode(array('type'=>'success','message'=>'Location has been '.($value == 'a' ? ' approved ' : 'rejected ').' successfully'));
