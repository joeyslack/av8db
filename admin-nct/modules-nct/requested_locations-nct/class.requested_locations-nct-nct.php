...
class RequestedLocations extends Home {
...
//            print_r($this->data);exit();
    ...
    $licenses_endorsement_name = $content = '';
        ...
        $content .= 
                $this->displayBox(array("label" => "Commercial &nbsp;:", "value" => $this->isCommercial == 'y' ? 'Yes' : 'No')) .
    ...
    public function dataGrid() {
        ...
        foreach ($qrySel as $fetchRes) {
            ...
            $final_array = array(
                ...
                filtering($fetchRes["isCommercial"] == "y" ? "Yes" : "No"),
                filtering($fetchRes["isLicense"] == "y" ? "Yes" : "No"),
                filtering($fetchRes["isBoth"] == "y" ? "Yes" : "No"),
                filtering($fetchRes["isNone"] == "y" ? "Yes" : "No")
            );
