...
$headTitle = $type == 'add' ? 'Add' : ($type == 'edit' ? 'Edit' : 'Manage') . ' Business Approvals';
$winTitle = $headTitle . ' - ' . SITE_NM;
$breadcrumb = array($headTitle);

$searchArray = array();

$objCompany = new CompanyApprovals($module, $id, NULL, $searchArray, $type);
$pageContent = $objCompany->getPageContent();
//$toggle = $objCompany->toggel_switch(array("action" => "ajax." . $module . ".php?id=" . $id . "", "check" => 'abc'));
