<?php
	...
	if(INSTALL_TYPE == 'local'){
		$dirurl = $_SERVER["DOCUMENT_ROOT"] . '/connectin/';
		$siteurl = $protocol.SITENAME.'/connectin/';
...
<html lang="en">
	<head>
		<title>Connectin - Installation Details</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="container">
			...
			<div class="col-md-6">
				<div class="row">&nbsp;</div>
				<h3 style="color: #7aaace;">Connectin - Installation</h3>
				<form action="install-nct/install_db.php" id="install-form" method="POST">
					...
					<div class="row">
						<div class="form-group col-md-8">
							...
							<input type="db_name" readonly="" class="form-control" id="db_name" name="db_name" placeholder="ex. connectin (create the database first)">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-8">
