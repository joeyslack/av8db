<?php
Class validation {
    function __construct() { $this->id = 0; }
    ...
    function validate() {
        ...
        for ($i = 0; $i < $this->id; $i++) {
            ...
            switch ($authType) {
                ...
                case "date": {$errorMsg .= $this->validateDate(trim($postVar), $value, $error);break;}
                case "ftype": {$errorMsg .= $this->validateFileType($postVar, $value, $error);break;}
                case "fsize": {$errorMsg .= $this->validateFileSize($postVar, $value, $error);break;}
                case "imgwh": {$errorMsg .= $this->validateImageHeightWidth($postVar, $value, $error); break;}
                case "custom": {
    ...
    function availableFileTypes($ext) {
        switch ($ext) {
            case "txt":$type[0] = "text/plain";break;
            case "xml":$type[0] = "text/xml";$type[1] = "application/xml";break;
            case "csv":$type[0] = "text/x-comma-separated-values";$type[1]="application/octet-stream";$type[2]="text/plain";break;
            case "zip":$type[0] = "application/zip";break;
            case "tar":$type[0] = "application/x-gzip";break;
            case "ctar":$type[0] = "application/x-compressed-tar";break;
            case "pdf":$type[0] = "application/pdf";break;
            case "doc":$type[0] = "application/msword";$type[1] = "application/octet-stream";break;
            case "xls":$type[0] = "application/vnd.ms-excel";$type[1] = "application/vnd.oasis.opendocument.spreadsheet";break;
            case "ppt":$type[0] = "application/vnd.ms-powerpoint";break;

            case "jpg":$type[0] = "image/jpg";$type[1] = "image/jpeg";$type[2] = "image/pjpeg";break;
            case "gif":$type[0] = "image/gif";break;
            case "png":$type[0] = "image/png";break;
            case "bmp":$type[0] = "image/bmp";break;
            case "icon":$type[0] = "image/x-ico";break;
            case "font":$type[0] = "application/x-font-ttf";break;
        }
        return $type;
    }
    ...
    function availablePhoneType($country) {
        switch ($country) {
            case "in":$type[0] = '/^[0-9]{6,10}$/';$type[1] = '/^[\(][\+][0-9]{2}[\)][\[][0-9]{3,5}[\]][0-9]{6,10}$/';$type[2] = '/^[\+][0-9]{2}[0-9]{3,5}[0-9]{6,10}$/';$type[3] = '/^[0-9]{2}[\-][0-9]{6,10}$/';break;
            case "br":$type[0] = '/^([0-9]{2})?(\([0-9]{2})\)([0-9]{3}|[0-9]{4})-[0-9]{4}$/';break;
            case "fr":$type[0] = '/^([0-9]{2})?(\([0-9]{2})\)([0-9]{3}|[0-9]{4})-[0-9]{4}$/';break;
            case "us":$type[0] = '/^[\(][0-9]{3}[\)][0-9]{3}[\-][0-9]{4}$/';break;
            case "sw":$type[0] = '/^(([+][0-9]{2}[ ][1-9][0-9]{0,2}[ ])|([0][0-9]{1,3}[-]))(([0-9]{2}([ ][0-9]{2}){2})|([0-9]{3}([ ][0-9]{3})*([ ][0-9]{2})+))$/';break;
        }
        return $type;
    }
} ?>