    ...
    $.fn.scrollPagination = function (options) {
        ...
        return this.each(function () {
            ...
            if ($settings.scroll == true)
                ...
                $initmessage = 'Click for more content';

            // Append custom messages and extra UI
            if ($settings.addDiv)
            {
                $this.append('<div class="list-content"></div><div class="loading-bar flclear clearfix">' + $initmessage + '</div>');
            }
            else
            {
            ...
            if ($settings.scroll == true) {
                ...
                $(window).scroll(function () {
                    ...
                    if ((parseFloat($(window).scrollTop()) + parseFloat($(window).height())) > $this.height() && false == busy) {
