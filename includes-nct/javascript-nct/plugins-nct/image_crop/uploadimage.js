...
$(document).ready(function() {
    ...
    $(document).on('click', '.slider_image', function(event) {
        event.preventDefault();
        $("#avatarInput").val('');
        $("#hidden_image_id").html('slider_home');
        $("#which_types").val('slider_home');
        $(".cropper-bg").remove();
        $(".preview-md>img").remove();
        $(".preview-lg>img").remove();
        $(".preview-sm>img").remove();
    ...
    $(document).on('click', '.activity_image', function(event) {
        event.preventDefault();
        $("#avatarInput").val('');
        $("#hidden_image_id").html('activity_image');
        $("#which_types").val('activity_image');
        $(".cropper-bg").remove();
        $(".preview-md>img").remove();
        $(".preview-lg>img").remove();
        $(".preview-sm>img").remove();
    ...
    $(document).on('click', '.company_image', function(event) {
        event.preventDefault();
        $("#avatarInput").val('');
        $("#hidden_image_id").html('company');
        $("#which_types").val('company');
        $(".cropper-bg").remove();
        $(".preview-md>img").remove();
        $(".preview-lg>img").remove();
        $(".preview-sm>img").remove();
    ...
    $(document).on('click', '#cover_picture', function(event) {
        event.preventDefault();
        $("#avatarInput").val('');
        $("#hidden_image_id").html('cover_photo_user');
        $("#which_types").val('cover_photo_user');
        $(".cropper-bg").remove();
        $(".preview-md>img").remove();
        $(".preview-lg>img").remove();
        $(".preview-sm>img").remove();
