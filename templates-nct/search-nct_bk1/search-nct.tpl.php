            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9">
                    <div class="srch-rgt-list">
                        ...
                        <div class="clearfix"></div>
                        <!-- <div id="pagination_container" class="center-block text-right"><?php //echo $this->pagination; ?></div> -->
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="" name="advanced_filter_options_form" id="advanced_filter_options_form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                    <div class="col-sm-12 col-md-12 form-group cf %RELATIONSHIP_FILTER_HIDDEN% filter-box">%ADV_RELATIONSHIP_FILTER%</div>
                    </div>
                    <div class="row">
                       <div class="col-sm-6 col-md-4 filter-box %EMPLOYMENT_TYPE_FILTER_HIDDEN%">%ADV_EMPLOYMENT_TYPE_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %ADV_CURRENT_COMPANY_FILTER_HIDDEN%">%ADV_CURRENT_COMPANY_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %INDUSTRIES_FILTER_HIDDEN%">%ADV_INDUSTRIES_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %ADV_GROUPS_FILTER_HIDDEN%">%ADV_GROUPS_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %ADV_JOB_CATEGORIES_FILTER_HIDDEN%">%ADV_JOB_CATEGORIES_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %COMPANY_SIZES_FILTER_HIDDEN%">%ADV_COMPANY_SIZES_FILTER%</div>
                        <div class="col-sm-6 col-md-4 filter-box %NO_OF_FOLLOWERS_FILTER_HIDDEN%">%ADV_NO_OF_FOLLOWERS_FILTER%</div>
                         <div class="col-sm-6 col-md-4 filter-box %SORTINGS_FILTER_HIDDEN%">%ADV_SORTINGS_FILTER%</div>
                    </div>
                </div>
