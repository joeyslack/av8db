            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 dash-search">
                    ...
                    <div class="srch-conn-bx">
                        ...
                        <i class="icon-srch"></i>
                        <input type="text" id="searchFollowing" name="searchFollowing" placeholder="{LBL_SEARCH}">
                        </div>
                    </div>
                    
                    <div  id="following" class="flex-row">
...
<script type="text/javascript">
    $(document).on("click", ".buttonPage", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo SITE_URL; ?>getFollowingAjax",
            data: {
                page: page,
...
$(document).ready(function(){
    ...
    $("#searchFollowing").keyup(function(){
...
$(document).on("click", ".load_more", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status) {
                    $("#following").find(".load-more-data").remove();
                    $("#following").append(data.content);
...
function loadMoreRecordfordata(url) {
        $.ajax({
            ...
            success: function(data) {
                if (data.status) {
                    $("#followingfollowing").find(".view-more-btn a").remove();
                    $("#following").append(data.content);
