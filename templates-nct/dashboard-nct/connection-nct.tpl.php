        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 dash-search">
                    ...
                    <div  id="connection" class="flex-row">
                            <?php echo $this->connection; ?>
...
<script type="text/javascript">
    $(document).on("click", ".buttonPage", function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo SITE_URL; ?>getConnectionAjax",
            data: {
                page: page,
...
$(document).on("click","#follow_user",function(){
    ...
    $(document).on("click", ".load_more", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status) {
                    $("#connection").find(".load-more-data").remove();
                    $("#connection").append(data.content);
    ...
    function loadMoreRecordfordata(url) {
        $.ajax({
            ...
            success: function(data) {
                if (data.status) {
                    $("#connection").find(".view-more-btn a").remove();
                    $("#connection").append(data.content);
